...
const GAUGE_VIEW_OPTIONS = [
  {
    ...
    text: 'Wider areas show where the drum has more of a trait. Tighter areas show where the voice is more restrained.',
  },
  {
    id: 'balance',
    label: 'Balance',
    title: 'Look for the lean, not just the score.',
    text: 'A useful drum voice does not need to be flat or neutral. The map helps show which traits lead and which traits support the player.',
  },
  {
    id: 'playerRead',
    label: 'Player Read',
    title: 'Turn the chart into drummer language.',
    text: 'The map matters most when it helps someone say what they actually hear and feel: quick, warm, open, controlled, sensitive, forward, or refined.',
  },
];
...
const RELATIONSHIPS = [
  {
    ...
    hear: 'A quicker front edge with enough top-end detail to feel crisp and articulate.',
  ...
  },
  {
    ...
    hear: 'A drum that does not just sound clear up close, but keeps that clarity as it moves outward.',
  ...
  },
  {
    ...
    hear: 'A voice that projects strongly and leaves air or ring behind the initial stroke.',
  ...
  },
  {
    ...
    hear: 'A note that opens up without getting thin, papery, or all top-end.',
  ...
  },
  {
    ...
    hear: 'A drum that keeps weight under the note even when the player backs off.',
  ...
  },
  {
    ...
    hear: 'A sensitive drum that still keeps ghost notes, wires, and overtones organized.',
    playerWords: ['detailed', 'controlled', 'clean response'],
    watchOut: 'Too much control can make a sensitive drum feel less alive.',
  },
  {
    id: 'attack_warmth',
    ...
    hear: 'Clear first contact with enough fullness to avoid sounding thin or papery.',
  ...
  },
  {
    ...
    hear: 'A drum that can step forward in a mix while still sounding organized and usable.',
    playerWords: ['powerful', 'focused', 'mix-ready'],
    watchOut: 'Too much focus can reduce the sense of size or movement.',
  },
  {
    ...
    hear: 'Enough clarity to hear detail, but enough organization to keep the top end from feeling brittle.',
    playerWords: ['clear but smooth', 'crisp not harsh', 'polished'],
    watchOut: 'If over-controlled, the drum can lose sparkle or openness.',
  },
  {
    id: 'sustain_control',
    ...
    hear: 'A note that opens after the hit but settles in a way that stays musical.',
  ...
  },
  {
    ...
    hear: 'Low-mid body that stays focused instead of turning cloudy or undefined.',
    playerWords: ['full but clean', 'warm but focused', 'round'],
    watchOut: 'Too much body without clarity can disappear in dense mixes.',
  },
  {
    ...
    hear: 'A voice with enough top-end detail to stay clear and enough center to avoid sounding thin.',
...
const getMeta = (key) => {
  ...
  const meta =
    LEGACYPRINT_AXIS_META?.[label] || LEGACYPRINT_AXIS_META?.[key] || {};
...
const LegacyPrintVoiceMapModal = ({ onClose }) => {
  ...
  const [activeRelationshipId, setActiveRelationshipId] =
    useState('attack_warmth');
  ...
  const activePlayStep =
    NODE_PLAY_STEPS[activeNodeKey] || NODE_PLAY_STEPS.attack;
  ...
  const selectedSample =
    LEGACYPRINT_SNARE_SAMPLES.find(
  ...
  const legacyFocusMode =
    soloNodeKeys.length > 0
      ? 'solo'
      : muteNodeKeys.length > 0
        ? 'mute'
        : 'full';
  ...
  const playCurrentHit = useCallback(
    async (
      ...
      try {
          ...
          focusMode:
            resolvedFocus.soloNodeKeys?.length > 0
              ...
              : resolvedFocus.muteNodeKeys?.length > 0
                ...
                : 'full',
          focusNodeKey:
            resolvedFocus.soloNodeKeys?.[0] ||
            resolvedFocus.muteNodeKeys?.[0] ||
            null,
          hitStrength,
          engineMode,
        });
        ...
        setAudioError(
          'Could not play that sample yet. Check the audio file path.'
        );
      } finally {
        window.setTimeout(() => {
          ...
          <aside className="lp-readout-panel">
            {activeMode === 'playCycle' && (
              <>
                ...
                <p className="lp-panel-lede">
                  ...
                  listening path. A snare hit starts with the strike, finds
                  clarity, moves outward, blooms, gains body, answers the
                  player’s touch, and finally settles into refinement.
                </p>
                ...
                <div className="lp-listening-index lp-play-cycle-index">
                  {NODE_ORDER.map((key) => {
                    ...
                    return (
                      ...
                      >
                        <span className="lp-listening-number">
                          {step.number}
                        </span>
                ...
                >
                  <div className="lp-field-note-heading">
                    ...
                    <div>
                      ...
                      <small>
                        {activePlayStep.step} · {activeNode.low} /{' '}
                        {activeNode.high}
                      </small>
                    </div>
                  </div>
                ...
                <div className="lp-bench-note">
                  ...
                  <span>
                    Move into Voice Sculptor when you are ready to shape and
                    audition the sound itself.
                  </span>
                </div>
              </>
            )}
            ...
            {activeMode === 'voiceSculptor' && (
              <>
                <section className="lp-node-mixer-box" aria-label="Voice mixer">
                  <div className="lp-mixer-topline">
                    <div>
                      ...
                      <strong>
                        {getFocusReadout(soloNodeKeys, muteNodeKeys)}
                      </strong>
                    </div>
                    ...
                    <div className="lp-quiet-selector lp-hit-selector">
                      {HIT_STRENGTH_OPTIONS.map((option) => (
                        <button
                          ...
                          type="button"
                          className={
                            hitStrength === option.id ? 'is-active' : ''
                          }
                ...
                <p className="lp-panel-lede">
                  Voice Sculptor is the hands-on model. Adjust the inner shape,
                  switch drum examples, solo or mute nodes, and listen for how
                  each trait changes the hit.
                </p>
            ...
            {activeMode === 'voiceGauge' && (
              <>
                ...
                <p className="lp-panel-lede">
                  Voice Gauge turns the seven nodes into a visual voice shape.
                  The dotted reference shows a neutral center. The colored shape
                  shows where this drum leans.
                </p>
                ...
                <div className="lp-quiet-selector">
                  {GAUGE_VIEW_OPTIONS.map((option) => (
                    <button
                      ...
                      type="button"
                      className={
                        activeGaugeView === option.id ? 'is-active' : ''
                      }
                ...
                <div className="lp-bench-note">
                  ...
                  <span>
                    Explore Node Relationships to see how two traits shape one
                    another.
                  </span>
                </div>
              </>
            ...
            {activeMode === 'relationship' && (
              <>
                ...
                <p className="lp-panel-lede">
                  Select a relationship to hear how two parts of the voice shape
                  each other. This helps turn vague player language into a
                  clearer sound direction.
                </p>
                ...
                <div className="lp-bench-note">
                  ...
                  <span>
                    Try Voice Finder Preview to see how player language can
                    become a target direction.
                  </span>
                </div>
              </>
            )}
            ...
            {activeMode === 'voiceFinder' && (
              <>
                ...
                <p className="lp-panel-lede">
                  This preview shows how guided listening questions can
                  translate player language into a clearer drum voice target.
                </p>
                  ...
                  <span>
                    {finderAnswers.length === 0
                      ...
                      : `This sample direction is leaning toward ${finderAnswers
                          ...
                          .join(
                            ', '
                          )}. A full finder would turn this into a more complete voice summary.`}
                  </span>
                </div>
                ...
                <div className="lp-bench-note">
                  ...
                  <span>
                    Voice Finder is a conversation starter. Final fit still
                    depends on the player, room, tuning, heads, sticks, and
                    expert judgment.
                  </span>
                </div>
              </>
