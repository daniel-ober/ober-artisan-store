...
import './Step8HardwareAssembly.css';

const defaultChecklist = [
  { task: 'Install lugs using washers and lock nuts', completed: false, totalSeconds: 0 },
  { task: 'Mount throw-off and butt plate', completed: false, totalSeconds: 0 },
  { task: 'Attach snare beds with clean alignment', completed: false, totalSeconds: 0 },
  { task: 'Secure tension rods + washers', completed: false, totalSeconds: 0 },
  { task: 'Align and center all hardware visually', completed: false, totalSeconds: 0 },
  { task: 'Document hardware spec (brand/finish)', completed: false, totalSeconds: 0 },
];

const Step8HardwareAssembly = ({ stepData = {}, onToggleChecklist }) => {
  ...
  return (
    <div className="step8-container">
      <h3 className="step8-title">Step 8: Hardware Assembly</h3>
      <div className="step8-checklist">
...
export default Step8HardwareAssembly;