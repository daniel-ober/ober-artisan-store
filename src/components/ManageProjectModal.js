...
//     projectData?.storyEngine?.discoveryBridge ||
//     editableData?.storyEngine?.discoveryBridge ||
//     {};

//   const bridgeSafeToSayNow = Array.isArray(
//     discoveryBridge?.buildDirectionSnapshot?.safeToSayNow
//   )
//     ? discoveryBridge.buildDirectionSnapshot.safeToSayNow
//     : [];

//   const bridgeUnsafeToAssumeNow = Array.isArray(
//     discoveryBridge?.buildDirectionSnapshot?.unsafeToAssumeNow
//   )
//     ? discoveryBridge.buildDirectionSnapshot.unsafeToAssumeNow
//     : [];

//   const bridgeLikelyDecisionAreasNext = Array.isArray(
//     discoveryBridge?.buildDirectionSnapshot?.likelyDecisionAreasNext
//   )
//     ? discoveryBridge.buildDirectionSnapshot.likelyDecisionAreasNext
//     : [];

//   const bridgeBuildBlockers = Array.isArray(
//     discoveryBridge?.globalBuildBlockers
//   )
//     ? discoveryBridge.globalBuildBlockers
//     : [];

//   const bridgeConsultPriorities = Array.isArray(
//     discoveryBridge?.globalConsultPriorities
//   )
//     ? discoveryBridge.globalConsultPriorities
//     : [];

//   const bridgeConsultFlow = Array.isArray(discoveryBridge?.proposedConsultFlow)
//     ? discoveryBridge.proposedConsultFlow
//     : [];

//   const hasDiscoveryBridge =
//     bridgeSafeToSayNow.length > 0 ||
//     bridgeUnsafeToAssumeNow.length > 0 ||
//     bridgeLikelyDecisionAreasNext.length > 0 ||
//     bridgeBuildBlockers.length > 0 ||
//     bridgeConsultPriorities.length > 0 ||
//     bridgeConsultFlow.length > 0 ||
//     !!discoveryBridge?.overallBuildReadiness;

//   const renderBridgeList = (items = []) => {
//     if (!items.length) {
//       return <div className="mpm-code-empty">Nothing captured yet.</div>;
//     }

//     return (
//       <ul className="mpm-summary-list">
//         {items.map((item, idx) => (
//           <li key={`${String(item)}-${idx}`}>{item}</li>
//         ))}
//       </ul>
//     );
//   };
...
//                     <section
//                       className={`mpm-intake-section ${
//                         expandedIntakeSections.bridge ? 'is-open' : ''
//                       }`}
//                     >
//                       <button
//                         type="button"
//                         className="mpm-intake-section-toggle"
//                         onClick={() => toggleIntakeSection('bridge')}
//                       >
//                         <div className="mpm-intake-section-toggle-copy">
//                           <span className="mpm-intake-section-kicker">
//                             Section 3
//                           </span>
//                           <h4>Bridge Notes & Readiness</h4>
//                           <p>
//                             Story-engine discovery bridge, current truths, open
//                             decisions, and consult priorities.
//                           </p>
//                         </div>
//                         <span className="mpm-intake-section-toggle-icon">
//                           {expandedIntakeSections.bridge ? '−' : '+'}
//                         </span>
//                       </button>
...
//                                 <div className="mpm-summary-shell">
//                                   <strong>
//                                     {fmtMDY(discoveryBridge?.generatedAt)}
//                                   </strong>
//                                 </div>
//                               </div>
...
//                                 </span>
//                                 <div className="mpm-summary-shell">
//                                   {renderBridgeList(bridgeSafeToSayNow)}
//                                 </div>
//                               </div>

//                               <div className="mpm-story-field">
//                                 <span className="mpm-story-field-label">
//                                   Unsafe To Assume Now
//                                 </span>
//                                 <div className="mpm-summary-shell">
//                                   {renderBridgeList(bridgeUnsafeToAssumeNow)}
//                                 </div>
//                               </div>

//                               <div className="mpm-story-field">
//                                 <span className="mpm-story-field-label">
//                                   Likely Decision Areas Next
//                                 </span>
//                                 <div className="mpm-summary-shell">
//                                   {renderBridgeList(
//                                     bridgeLikelyDecisionAreasNext
//                                   )}
//                                 </div>
//                               </div>
...
//                               <div className="mpm-story-field">
//                                 <span className="mpm-story-field-label">
//                                   Global Build Blockers
//                                 </span>
//                                 <div className="mpm-summary-shell">
//                                   {renderBridgeList(bridgeBuildBlockers)}
//                                 </div>
//                               </div>

//                               <div className="mpm-story-field">
//                                 <span className="mpm-story-field-label">
//                                   Global Consult Priorities
//                                 </span>
//                                 <div className="mpm-summary-shell">
//                                   {renderBridgeList(bridgeConsultPriorities)}
//                                 </div>
//                               </div>

//                               <div className="mpm-story-field">
//                                 <span className="mpm-story-field-label">
//                                   Proposed Consult Flow
//                                 </span>
//                                 <div className="mpm-summary-shell">
//                                   {renderBridgeList(bridgeConsultFlow)}
//                                 </div>
//                               </div>
...
//                               No bridge notes have been generated for this
//                               project yet.
//                             </div>
//                           )}
//                         </div>
