...
const HardwareDrilling = ({ stepData, onToggleChecklist, onSaveNotes, onUpdateTimestamp }) => {
  return (
    <div>
      <h4>Hardware Drilling</h4>

      {/* Timestamps */}
      <div className="step-timestamps">
        <button
          onClick={() => onUpdateTimestamp("hardwareDrilling", "start")}
        ...
        <button
          onClick={() => onUpdateTimestamp("hardwareDrilling", "complete")}
...
export default HardwareDrilling;