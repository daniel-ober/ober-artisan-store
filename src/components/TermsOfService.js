  ...
  return (
    <div ref={ref} className="terms-of-service-container">
      ...
      <p>
        ...
        our site or making a purchase. By continuing to use our services, you
        agree to abide by these terms in full. We may update these terms at any
        time without prior notice, and the version in effect at the time of your
      ...
      <p>
        ...
        reserve the right to cancel or modify orders at our discretion,
      ...
      <p>
        ...
        provisions related to payment plans, promotional pricing, and
        non-refundable items.
      </p>

      <h2>8. Intellectual Property</h2>
      <p>
        All site content—including text, graphics, media, and design—is the
        exclusive property of Ober Artisan Drums or its licensors. No content
        may be reused, distributed, or reproduced without written permission.
      </p>
      ...
      <p>
        We reserve the right to restrict access, block IPs, or take legal action
        in response to any prohibited behavior.
      </p>

      <h2>10. Limitation of Liability</h2>
      <p>
        Use of this site is at your own risk. We are not liable for indirect,
        incidental, or consequential damages, or for service interruptions, data
        loss, or third-party breaches.
      </p>
