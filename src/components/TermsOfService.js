  ...
  return (
    <div ref={ref} className="terms-of-service-container">
      ...
      <p>
        ...
        our site, tools, content, and services, or when making a purchase from
        Ober Artisan Drums. By continuing to use our services, you agree to
        abide by these terms in full. We may update these terms at any time
        without prior notice, and the version in effect at the time of your
        interaction or transaction will apply. We recommend reviewing them
        carefully.
      </p>
      ...
      <p>
        ...
        under your account. We reserve the right to suspend or terminate access
        to accounts involved in misuse, fraud, abuse, or unauthorized activity.
      </p>
      ...
      <p>
        ...
        that all information is always complete, current, or error-free. We
        ...
        errors, inventory issues, or operational constraints.
      </p>
      ...
      <p>
        ...
        the displayed amount, including applicable taxes, shipping, and any
      ...
      <p>
        ...
        provisions related to payment plans, promotional pricing, made-to-order
        items, and non-refundable items.
      </p>
      ...
      <p>
        ...
        interface concepts, downloadable materials, and proprietary creative
        systems—is the exclusive property of Ober Artisan Drums or its
        licensors, unless otherwise stated. No content may be reused,
        distributed, reproduced, republished, reverse engineered, or exploited
      ...
      <p>
        ...
        systems or their outputs without express written permission from Ober
        Artisan Drums.
      </p>
      ...
      <p>
        ...
        media, or other content. You retain ownership of content you submit, but
        by submitting content to these features, you grant Ober Artisan Drums a
        non-exclusive, worldwide, royalty-free license to host, store, review,
      ...
      <p>
        ...
        the obligation, to review, reject, edit, limit, hide, or remove any
        submitted content at our discretion, including content that is unlawful,
        infringing, abusive, misleading, defamatory, obscene, unsafe, or
        inconsistent with our brand standards.
      </p>
