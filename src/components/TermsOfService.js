...
const TermsOfService = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="terms-of-service-container">
      ...
      <p>
        By accessing or using the Dan Ober Artisan Drums website, you agree to be bound by these Terms of Service and our Privacy Policy. 
        <br />
      ...
      <p>
        To make a purchase or access certain features, you may need to create an account. 
        <br />
      ...
      <p>
        ...
        <br />
        However, we do not guarantee the accuracy, completeness, or reliability of product descriptions or prices.
        <br />
      ...
      <p>
        ...
        <br />
        By providing payment information, you authorize us to charge the applicable amount to your payment method.
      </p>

      <h2>6. Shipping and Delivery</h2>
      <p>
        We will make reasonable efforts to process and ship orders in a timely manner. 
        <br />
        Delivery times may vary depending on your location and other factors.
      </p>

      <h2>7. Returns and Refunds</h2>
      <p>
        Our return and refund policy is outlined separately on our website. 
        <br />
      ...
      <p>
        All content on our website, including text, images, and logos, is owned by Dan Ober Artisan Drums or its licensors and is protected by intellectual property laws. 
        <br />
        You may not use or reproduce any content without our permission.
      </p>
      ...
      <p>
        ...
        <br />
        Any changes will be posted on this page, and your continued use of the website constitutes acceptance of the updated terms.
      </p>
