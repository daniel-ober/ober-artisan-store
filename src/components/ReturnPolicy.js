  ...
  return (
    <div className="return-policy-container">
      ...
      <p>
        ...
        <br />
        <strong>Contact Us:</strong> Email us at <strong>returns@danoberartisan.com</strong> with your order number, a description of the issue, and photos if necessary.
        <br />
      ...
      <p>
        Custom products, including but not limited to custom drums, drum kits, or custom-engraved merchandise, are <strong>non-returnable</strong> unless defective or damaged upon arrival.
      </p>
      ...
      <p>
        ...
        <br />
        <strong>Other Products:</strong> For all other items, you may cancel your order as long as it has not yet shipped. Please contact us at <strong>cancellations@danoberartisan.com</strong> for assistance.
      </p>
