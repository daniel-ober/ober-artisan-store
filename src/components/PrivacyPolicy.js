...
const PrivacyPolicy = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="privacy-policy-container">
      ...
      <p>
        We use your information for the following purposes: To process and fulfill orders, communicate with you about your orders and provide customer support, improve our website and services, send promotional emails and offers if you have opted-in to receive them, to comply with legal obligations.
      </p>
