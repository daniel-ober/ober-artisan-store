  ...
  return (
    <div ref={ref} className="privacy-policy-container">
      ...
      <p>
        ...
        We may update this policy at any time without prior notice, and the version in effect at the time of your interaction will apply. 
        We encourage all users to read this policy carefully to understand their rights and our obligations.
      </p>
      ...
      <p>
        We may link to third-party services such as Stripe, LinkedIn, or Meta properties. 
        We are not responsible for their privacy practices. Please review those third-party policies before submitting your data to them.
      </p>

      <h2>10. Changes to This Policy</h2>
      <p>
        We may update this policy periodically. The most current version will always appear here, and your continued use of our site implies acceptance of the current policy.
      </p>
